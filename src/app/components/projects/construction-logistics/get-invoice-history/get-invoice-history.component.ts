...
@Component({
  selector: 'app-get-invoice-history',
  templateUrl: './get-invoice-history.component.html',
  styleUrls: ['./get-invoice-history.component.scss']
})
export class GetInvoiceHistoryComponent implements OnInit {
  invoice = '';
  direction = '';
  city = '';
  businessName = '';
  ...
  constructor() {} //private i18: I18Service
